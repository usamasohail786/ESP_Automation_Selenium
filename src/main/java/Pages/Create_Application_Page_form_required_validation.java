...
public class Create_Application_Page_form_required_validation extends Test_Data {
	...
	@FindBy(xpath="(//input[@data-type=1]/ancestor::div)[1]")	
    ...
    public Create_Application_Page_form_required_validation(WebDriver driver) throws FileNotFoundException, IOException, ParseException {
    ...
    public void verify_required_sending_data_into_all_short_text() throws InterruptedException
    {
    	
    	Common_class com=new Common_class(driver);
        com.Explicit_wait_elements_visiblity(text_type_list, 10);
        com.get_elements_text_random(text_type_list);
     
    	
    		
    }
    public void verify_required_sending_data_into_all_look_up_fields() throws InterruptedException
    {
    ...
    public int verify_required_sending_data_into_all_email_field() throws InterruptedException
    {
    ...
    public void verify_required_upload_all_the_attachment() throws InterruptedException
    {
    	...
    	file_upload=com.file_attach_randomly_clear(file_upload_list);
    	
    	}
    	
    }
    public void verify_required_upload_all_the_Image() throws InterruptedException
    {
    ...
    public void verify_required_upload_all_the_Image_in_gallery() throws InterruptedException
    {
    	...
    	com.gallery_attach_randomly_clear(gallery_image_upload_list);
    	}
    	}
       
    }
    public void verify_required_sending_data_into_all_long_fields() throws InterruptedException
    {
    	Common_class com=new Common_class(driver);
    	com.Explicit_wait_elements_visiblity(long_text_type_list, 10);
    	long_text=com.get_elements_text_random_clear(long_text_type_list);
    	
       
    }
    public void verify_required_sending_data_into_all_numbers() throws InterruptedException
    {
    	Common_class com=new Common_class(driver);
    	com.Explicit_wait_elements_visiblity(number_list, 10);
    	numbers=com.get_random_number_clear(number_list);
    	
    	
       
    }
    public void verify_required_currency_data_into_all_fields() throws InterruptedException
    {
    	...
    	currency=com.get_random_number_clear(currency_fields);
    	
    	}
    	
    }
    public int verify_required_price_data_into_all_fields() throws InterruptedException
    {
    	
    	Common_class com=new Common_class(driver);
    	
    	com.Explicit_wait_elements_visiblity(price_fields, 10);
    	int price_size=com.get_random_number_clear(price_fields);
    	return price_size;
       
    }
    public void verify_required_sending_data_into_all_phone_numbers() throws InterruptedException
    {
    	
    	Common_class com=new Common_class(driver);
    	
    	com.Explicit_wait_elements_visiblity(phone_list, 10);
    	phone_number=com.get_random_phone_number_clear(phone_list);
    
       
    }
    public void verify_required_sending_data_into_all_links() throws InterruptedException
    {
    ...
    public void verify_required_click_on_all_dates_fields() throws InterruptedException
    {
    	Common_class com=new Common_class(driver);
    	com.Explicit_wait_elements_visiblity(date_list, 4);
    	com.remove_atribute(date_list);
    	date=com.send_date_on_list_clear(date_list);
    	
    	
    	
    }
    public void verify_required_on_all_date_time_fields() throws InterruptedException
    {
    	Common_class com=new Common_class(driver);
    	com.Explicit_wait_elements_visiblity(date_time_list, 4);	
    	com.remove_atribute(date_time_list);
    	date_time=com.send_date_on_list_clear(date_time_list);
